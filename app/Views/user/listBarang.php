        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse<?= $nomer ?>" aria-expanded="false" aria-controls="flush-collapse<?= $nomer ?>">
                ...
                <div id="flush-collapse<?= $nomer - 1 ?>" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
